...
pub async fn port_forward_start(
    ...
    let rule = match direction.as_str() {
        "local" => slopssh_core::ssh::port_forward::PortForwardRule::new_local(
            &bind_host,
            bind_port,
            &target_host,
            target_port,
        ),
        "remote" => slopssh_core::ssh::port_forward::PortForwardRule::new_remote(
            &bind_host,
            bind_port,
            &target_host,
            target_port,
    ...
    match rule.direction {
        slopssh_core::ssh::port_forward::ForwardDirection::Local => {
            let handle = {
        ...
        slopssh_core::ssh::port_forward::ForwardDirection::Remote => {
