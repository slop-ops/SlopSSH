...
mod tests {
    ...
    fn test_backup_rotation() {
        let dir = std::env::temp_dir().join("slopssh_test_backup_rotation");
    ...
    fn test_backup_rotation_removes_oldest() {
        let dir = std::env::temp_dir().join("slopssh_test_backup_oldest");
        let _ = std::fs::remove_dir_all(&dir);
        std::fs::create_dir_all(&dir).unwrap();
        let path = dir.join("sessions.json");
    ...
    fn test_save_and_load_roundtrip() {
        let dir = std::env::temp_dir().join("slopssh_test_roundtrip");
        let _ = std::fs::remove_dir_all(&dir);
        std::fs::create_dir_all(&dir).unwrap();
        let path = dir.join("sessions.json");
    ...
    fn test_backup_content_preserved() {
        let dir = std::env::temp_dir().join("slopssh_test_backup_content");
        let _ = std::fs::remove_dir_all(&dir);
        std::fs::create_dir_all(&dir).unwrap();
        let path = dir.join("sessions.json");
