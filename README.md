...
Output artifacts:
- `crates/slopssh-tauri/target/release/bundle/deb/slopssh_0.4.0_amd64.deb` — Debian package
- `crates/slopssh-tauri/target/release/bundle/appimage/slopssh_0.4.0_amd64.AppImage` — AppImage
...
Output artifacts:
- `crates\slopssh-tauri\target\release\bundle\nsis\SlopSSH_0.4.0_x64-setup.exe` — NSIS installer
- `crates\slopssh-tauri\target\release\bundle\msi\SlopSSH_0.4.0_x64_en-US.msi` — MSI installer
...
3. Create and push a git tag: `git tag v0.4.0 && git push origin v0.4.0`
